 ...
 * @author xueyintao
 */
public class LeadElect2 implements Watcher, Runnable {

	private ZooKeeper zk = null;
	private static String serverId = "2";
	boolean isRunning = false;

	public LeadElect2(ZooKeeper zk) {
		this.zk = zk;
	}
	...
	public void run() {
		...
		try {
			...
			System.out.println("serverId:" + serverId + ",firstNode:" + firstNode + ",leaderId:" + leaderId);
